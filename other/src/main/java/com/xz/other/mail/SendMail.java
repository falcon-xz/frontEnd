...
import com.xz.other.weather.WeatherMsg;
...
public class SendMail {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ts.connect("smtp.sina.com", "xzparty@sina.com", "5584143xz");
        //4、创建邮件
    ...
    */ 
    public static MimeMessage createSimpleMail(Session session)
        ...
        //邮件的文本内容
        WeatherMsg weatherMsg = new WeatherMsg("南京") ;
        String msg = weatherMsg.getWeatherInfo() ;
